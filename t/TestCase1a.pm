# Attention !
# this file is used only during make test on installation of bitflags::ct
...
use bitflags::ct {ic=>1}, qw( mercury venus earth mars );
use bitflags::ct qw( JUPITER SATURN URANUS NEPTUNE );
use bitflags::ct qw( pluto sedna );
